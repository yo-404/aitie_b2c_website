...
(function () {
    ...
    var letterDuration = 700;
    var letterStagger = 90;
    var dotDelayAfterLetters = 150;
    var dotDuration = 1100;
    ...
    /* Dots swap sides and spiral in: the left "i"'s dot starts far to
       ...
       the landing point whose radius decays to 0 over ~2.5 turns),
       entering the spiral from its starting side so the two visibly
       cross paths before corkscrewing down into place. direction flips
       the spiral's handedness per dot so they don't read as
       mirror-identical motion. */
