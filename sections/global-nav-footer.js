...
(function () {
    ...
    var css = ''
        ...
        + '.footer-location{display:flex;align-items:center;gap:0.35rem;color:#9ca3af;}'
        ...
        + '  .footer-logo-brand-wrap{display:flex !important;align-items:center !important;justify-content:space-between !important;width:100% !important;margin-top:2rem !important;padding-top:1.75rem !important;border-top:1px solid rgba(255,255,255,0.08) !important;}'
        + '  .footer-brand-meta{display:flex !important;flex-direction:column !important;align-items:flex-start !important;gap:0.5rem !important;}'
        + '  .footer-bottom-row{display:flex !important;flex-direction:column !important;align-items:center !important;justify-content:center !important;text-align:center !important;width:100% !important;padding-top:1rem !important;margin-top:0.75rem !important;border-top:none !important;gap:0.35rem !important;}'
        + '  .footer-location{display:flex !important;align-items:center !important;gap:0.25rem !important;}'
        ...
        + '  .hide-on-mobile, .footer-bottom-row .footer-location, .footer-bottom-row .footer-social-links{display:none !important;}'
        + '}';
    ...
    var footerHtml = ''
        ...
        + '                <div class="flex flex-row items-center footer-location hide-on-mobile">'
        + '                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24" class="mr-0.5 size-4 text-gray-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M10.368 19.102c.349 1.049 1.011 1.086 1.478.086l5.309-11.375c.467-1.002.034-1.434-.967-.967l-11.376 5.308c-1.001.467-.963 1.129.085 1.479l4.103 1.367 1.368 4.102z"></path></svg><span class="text-sm text-gray-400">Bangalore, India</span>'
        + '                </div>'
