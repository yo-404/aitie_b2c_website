...
(function () {
    ...
    var css = ''
        ...
        + '.footer-location{display:flex;align-items:center;gap:0.35rem;color:#9ca3af;order:2;}'
        + '.footer-rights{order:3;}'
        + '.footer-bottom-row .footer-social-links{order:4;}'
        ...
        + '  .footer-logo-brand-wrap{display:flex !important;align-items:center !important;justify-content:space-between !important;width:100% !important;margin-top:2rem !important;padding-top:0 !important;border-top:none !important;}'
        + '  .footer-brand-meta{display:flex !important;align-items:center !important;gap:0.5rem !important;}'
        + '  .footer-bottom-row{display:flex !important;flex-direction:column !important;align-items:center !important;justify-content:center !important;text-align:center !important;width:100% !important;padding-top:1.5rem !important;margin-top:1.5rem !important;border-top:1px solid rgba(255,255,255,0.08) !important;gap:0.35rem !important;}'
        + '  .footer-bottom-row .footer-copyright{order:1 !important;}'
        + '  .footer-bottom-row .footer-rights{order:2 !important;}'
        + '  .footer-bottom-row .footer-location{display:flex !important;align-items:center !important;justify-content:center !important;gap:0.25rem !important;order:3 !important;margin-top:0.35rem !important;}'
        + '  .footer-social-links{display:flex !important;align-items:center !important;gap:1rem !important;}'
        + '  .footer-social-icon{width:1.25rem !important;height:1.25rem !important;}'
        + '  .footer-grid > .footer-content-grid[aria-hidden="true"]{display:none;}'
        + '  .hide-on-mobile, .footer-bottom-row .footer-social-links{display:none !important;}'
        + '}';
    ...
    var footerHtml = ''
        ...
        + '                <div class="footer-logo-brand-wrap">'
        ...
        + '                    </div>'
        + '                  </a>'
        + '                  <div class="footer-brand-meta hide-on-desktop">'
        ...
        + '                <div class="text-sm text-gray-400 footer-copyright">© 2026 Aitie</div>'
        ...
        + '                <div class="footer-social-links hide-on-mobile">'
        + '                  <a href="mailto:app@aitie.co" aria-label="Email Aitie" class="footer-social-link w-inline-block">'
        + '                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="footer-social-icon"><rect x="2" y="4" width="20" height="16" rx="2"></rect><path d="m22 6-10 7L2 6"></path></svg>'
        + '                  </a>'
        + '                  <a href="https://www.linkedin.com/company/aitie-app/" target="_blank" rel="noopener noreferrer" aria-label="Aitie on LinkedIn" class="footer-social-link w-inline-block">'
